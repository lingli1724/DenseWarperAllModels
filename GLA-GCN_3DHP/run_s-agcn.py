...
dataset_path = 'data/data_3d_' + '3dhp' + '.npz'
...
keypoints = np.load('data/data_2d_' + '3dhp' + '_' + args.keypoints + '.npz', allow_pickle=True)
...
if not args.evaluate:
    ...
    while epoch < args.epochs:
        ...
        print(f'Now the smallest MPJPE is {best_3d_valid}')
