...
def parse_args():
    ...
    parser.add_argument('-str', '--subjects-train', default='S1,S2,S3,S4,S5,S6', type=str, metavar='LIST',
                        help='training subjects separated by comma')
    parser.add_argument('-ste', '--subjects-test', default='S7,S8', type=str, metavar='LIST', help='test subjects separated by comma')
    ...
    # Model arguments
    parser.add_argument('-s', '--stride', default=128, type=int, metavar='N', help='chunk size to use during training')
    ...
    parser.add_argument('-dep', default=7, type=int, help='depth of model')    
    ...
    parser.add_argument('-num_heads', default=8, type=int, help='num of heads')

    parser.add_argument('--context_length', default=20, type=int, help='context length')
    parser.add_argument('-arc', '--architecture', default='3,3,3', type=str, metavar='LAYERS', help='filter widths separated by comma')

    parser.add_argument('-slide_window_size', default=100, type=int, help='slide window size')
